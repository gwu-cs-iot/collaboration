...
| T 2.18 | Discussion leader: Sean McBride 4a. *Multiprogramming a 64 kB Computer Safely and Efficiently* ([pdf](https://github.com/gwu-iot/collaboration/blob/master/papers/sosp2017tock.pdf)); Discussion leader: Sam Frey 4b. *Predictable Virtualization on Memory Protection Unit-based Microcontrollers* ([pdf](https://github.com/gwu-iot/collaboration/blob/master/papers/rtas18virt.pdf)) | Paper reviews |
